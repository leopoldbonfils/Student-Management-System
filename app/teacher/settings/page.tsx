...
const navItems = [
  { name: 'Dashboard', Icon: MdPeople, href: '/teacher/students' },
        ...
        <div className="td-content">
          ...
          <div className="st-head-row">
            <div>
              ...
              <p className="sm-sub">
                Manage your account security, notification preferences, and system behavior to tailor your EduPortal experience.
              </p>
            </div>
            ...
            <div className="st-forms-col">
              ...
              <div className="st-card">
                <div className="st-card-header">
                  ...
                  <p className="st-card-desc">
                    Control how and when EduPortal alerts you about student activity and system updates.
                  </p>
                </div>
                ...
                <div className="st-form-body">
                  ...
                  <div className="st-toggle-item">
                    <div>
                      <h4 className="st-toggle-title">Attendance Alerts</h4>
                      <p className="st-toggle-desc">Daily summaries of student absences and tardies.</p>
                    </div>
                    <label className="st-switch">
                      <input 
                        type="checkbox" 
                  ...
                  <div className="st-toggle-item">
                    <div>
                      <h4 className="st-toggle-title">Grade & Submission Notices</h4>
                      <p className="st-toggle-desc">Get notified when new student submissions require review.</p>
                    </div>
                    <label className="st-switch">
                      <input 
                        type="checkbox" 
